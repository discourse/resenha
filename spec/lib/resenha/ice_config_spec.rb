...
RSpec.describe Resenha::IceConfig do
  fab!(:user)

  describe ".payload" do
    it "builds one entry per STUN url, ignoring blank segments" do
      SiteSetting.resenha_stun_servers = "stun:stun.example.com:3478| |stun:stun2.example.com:19302"
    ...
    it "attaches the static username and credential to every static TURN url" do
      ...
      SiteSetting.resenha_turn_servers = "turn:turn.example.com:3478|turns:turn.example.com:5349"
      SiteSetting.resenha_turn_username = "static-user"
      SiteSetting.resenha_turn_credential = "static-pass"
    ...
    it "omits the username and credential keys when the static credentials are blank" do
      SiteSetting.resenha_stun_servers = ""
      SiteSetting.resenha_turn_servers = "turn:turn.example.com:3478"
    ...
    it "keeps static and secret TURN servers side by side with their own credentials" do
      SiteSetting.resenha_stun_servers = ""
      SiteSetting.resenha_turn_servers = "turn:third-party.example.com:3478"
      SiteSetting.resenha_turn_username = "static-user"
      SiteSetting.resenha_turn_credential = "static-pass"
      SiteSetting.resenha_turn_secret = "coturn-shared-secret"
    ...
    it "skips secret TURN servers when the shared secret has been blanked" do
      ...
      SiteSetting.resenha_turn_secret = "coturn-shared-secret"
      SiteSetting.resenha_turn_secret_servers = "turn:coturn.example.com:3478"
      SiteSetting.resenha_turn_secret = ""
    ...
    it "keeps policy 'all' when STUN servers are configured alongside static TURN" do
      SiteSetting.resenha_stun_servers = "stun:stun.example.com:3478"
      SiteSetting.resenha_turn_servers = "turn:turn.example.com:3478"
      SiteSetting.resenha_turn_credential = "static-pass"
