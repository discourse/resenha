...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let e=t=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(t)];return this.uniforms.map(t=>[e(t.type),t.length??1])}},Yc=(e,t)=>new du(e,t)}),Yt=L(()=>{"use strict";ne(),ie(),Me(),se(),cu=(e,t)=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.");if(t.length!==0&&t.length!==e[0].dims.length)throw new Error(`perm size ${t.length} does not match input rank ${e[0].dims.length}`)},Pi=(e,t)=>t.length!==0?t:[...new Array(e).keys()].reverse(),pu=(e,t)=>O.sortBasedOnPerm(e,Pi(e.length,t)),hu=(e,t,r,n)=>{let i=`fn perm(i: ${n.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`;for(let s=0;s<t;++s)i+=`a[${e[s]}]=i[${s}];`;return i+="return a;}"},fu=(e,t)=>{let r=[],n=[];for(let i=0;i<e.length;++i)e[i]!==1&&r.push(e[i]),e[t[i]]!==1&&n.push(t[i]);return{newShape:r,newPerm:n}},mu=(e,t)=>{let r=0;for(let n=0;n<e.length;++n)if(t[e[n]]!==1){if(e[n]<r)return!1;r=e[n]}return!0},Je=(e,t)=>{let r=e.dataType,n=e.dims.length,i=Pi(n,t),s=pu(e.dims,i),a=e.dims,u=s,l=n<2||mu(i,e.dims),d;if(l)return d=_=>{let b=R("input",r,a,4),k=Z("output",r,u,4);return`
  ${_.registerUniform("output_size","u32").declareVariables(b,k)}
  ${_.mainStart()}
    ${_.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
    output[global_idx] = input[global_idx];
  }`},{name:"TransposeCopy",shaderCache:{inputDependencies:["type"]},getRunData:()=>{let _=O.size(s);return{outputs:[{dims:s,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(_/64/4)},programUniforms:[{type:12,data:Math.ceil(_/4)}]}},getShaderSource:d};let{newShape:p,newPerm:h}=fu(e.dims,i),g=O.areEqual(h,[2,3,1]),y=O.areEqual(h,[3,1,2]);if(p.length===2||g||y){a=g?[p[0],p[1]*p[2]]:y?[p[0]*p[1],p[2]]:p,u=[a[1],a[0]];let _=16;return d=b=>{let k=R("a",r,a.length),v=Z("output",r,u.length);return`
    ...
    ${k.setByOffset("global_idx",b.getByIndices("aIndices"))}
  }`},{name:"Transpose",shaderCache:{hint:`${t}`,inputDependencies:["rank"]},getRunData:()=>{let _=O.size(s);return{outputs:[{dims:s,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(_/64)},programUniforms:[{type:12,data:_},...te(a,u)]}},getShaderSource:d}},Jc=(e,t)=>{cu(e.inputs,t.perm),e.compute(Je(e.inputs[0],t.perm))},ep=e=>ye({perm:e.perm})}),j0=L(()=>{"use strict";ne(),ie(),se(),Vs(),Yt(),gu={max:"select(bestValue, candidate, candidate > bestValue)",min:"select(bestValue, candidate, candidate < bestValue)",mean:"bestValue + candidate",sum:"bestValue + candidate",prod:"bestValue * candidate",sumSquare:"bestValue + candidate * candidate",logSumExp:"bestValue + exp(candidate)",l1:"bestValue + abs(candidate)",l2:"bestValue + candidate * candidate",logSum:"bestValue + candidate"},_u={max:"select(bestValue, candidate, candidate > bestValue)",min:"select(bestValue, candidate, candidate < bestValue)",mean:"bestValue + candidate",sum:"bestValue + candidate",prod:"bestValue * candidate",sumSquare:"bestValue + candidate",logSumExp:"bestValue + candidate",l1:"bestValue + candidate",l2:"bestValue + candidate",logSum:"bestValue + candidate"},yu={max:"_A[offset]",min:"_A[offset]",mean:"0",sum:"0",prod:"1",sumSquare:"0",logSumExp:"0",l1:"0",l2:"0",logSum:"0"},wu={max:"bestValue",min:"bestValue",sum:"bestValue",prod:"bestValue",sumSquare:"bestValue",logSumExp:"log(bestValue)",l1:"bestValue",l2:"sqrt(bestValue)",logSum:"log(bestValue)"},bu=(e,t)=>{let r=[];for(let n=t-e;n<t;++n)r.push(n);return r},$u=(e,t)=>{let r=[],n=e.length;for(let s=0;s<n;s++)t.indexOf(s)===-1&&r.push(e[s]);let i=t.map(s=>e[s]);return[r,i]},vu=(e,t)=>{let r=e.length+t.length,n=[],i=0;for(let s=0;s<r;s++)t.indexOf(s)===-1?n.push(e[i++]):n.push(1);return n},xu=(e,t)=>{for(let r=0;r<e.length;++r)if(e[e.length-r-1]!==t-1-r)return!1;return!0},ku=(e,t)=>{let r=[];if(!xu(e,t)){for(let n=0;n<t;++n)e.indexOf(n)===-1&&r.push(n);e.forEach(n=>r.push(n))}return r},Su=(e,t,r,n,i,s,a)=>{let u=r[0].dims,l=O.size(s),d=O.size(a),p=R("_A",r[0].dataType,u),h=Z("output",i,s),g=64;l===1&&(g=256);let y=`
       ...
       `,_=b=>`
        ...
        fn DIV_CEIL(a : u32, b : u32) -> u32 {
         ...
         if (local_idx == 0u) {
          ${h.setByOffset("outputIndex",`${n==="mean"?`${h.type.storage}(bestValue / f32(uniforms.reduceSize))`:`${h.type.storage}(${wu[n]})`}`)};
         }
        }`;return{name:e,shaderCache:{hint:`${t};${g}`,inputDependencies:["type"]},getShaderSource:_,getRunData:()=>({outputs:[{dims:s,dataType:i}],dispatchGroup:{x:l},programUniforms:[{type:12,data:d}]})}},ut=(e,t,r,n)=>{let i=e.inputs.length===1?r:bs(e.inputs,r),s=i.axes;s.length===0&&!i.noopWithEmptyAxes&&(s=e.inputs[0].dims.map((y,_)=>_));let a=O.normalizeAxes(s,e.inputs[0].dims.length),u=a,l=e.inputs[0],d=ku(u,e.inputs[0].dims.length);d.length>0&&(l=e.compute(Je(e.inputs[0],d),{inputs:[0],outputs:[-1]})[0],u=bu(u.length,l.dims.length));let[p,h]=$u(l.dims,u),g=p;i.keepDims&&(g=vu(p,a)),e.compute(Su(t,i.cacheKey,[l],n,e.inputs[0].dataType,g,h),{inputs:[l]})},tp=(e,t)=>{ut(e,"ReduceMeanShared",t,"mean")},rp=(e,t)=>{ut(e,"ReduceL1Shared",t,"l1")},np=(e,t)=>{ut(e,"ReduceL2Shared",t,"l2")},ip=(e,t)=>{ut(e,"ReduceLogSumExpShared",t,"logSumExp")},sp=(e,t)=>{ut(e,"ReduceMaxShared",t,"max")},ap=(e,t)=>{ut(e,"ReduceMinShared",t,"min")},op=(e,t)=>{ut(e,"ReduceProdShared",t,"prod")},up=(e,t)=>{ut(e,"ReduceSumShared",t,"sum")},lp=(e,t)=>{ut(e,"ReduceSumSquareShared",t,"sumSquare")},dp=(e,t)=>{ut(e,"ReduceLogSumShared",t,"logSum")}}),Vs=L(()=>{"use strict";ne(),ie(),Me(),se(),j0(),lt=e=>{if(!e||e.length===0||e.length>2)throw new Error("Reduce op requires 1 or 2 inputs.");if(e.length===2&&e[1].dims.length!==1)throw new Error("Invalid axes input dims.")},Tu=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],Ln=(e,t,r,n,i,s,a=!1,u=!1)=>{let l=[],d=r[0].dims,p=d.length,h=O.normalizeAxes(i,p),g=!u&&h.length===0;d.forEach((b,k)=>{g||h.indexOf(k)>=0?a&&l.push(1):l.push(b)});let y=l.length,_=O.size(l);return{name:e,shaderCache:t,getShaderSource:b=>{let k=[],v=R("_A",r[0].dataType,p),w=Z("output",s,y),T=n(v,w,h),S=T[2];for(let I=0,C=0;I<p;I++)g||h.indexOf(I)>=0?(a&&C++,S=`for(var j${I}: u32 = 0; j${I} < ${d[I]}; j${I}++) {
...
var best_index : i32 = 0;`,`if (${n.getByIndices("input_indices")} ${t.selectLastIndex>0?">=":">"} value) {
  ...
  }`};return e.compute({name:"AttentionPrepare",shaderCache:{inputDependencies:["type","type","type"]},getRunData:()=>({outputs:[{dims:r,dataType:e.inputs[0].dataType,gpuDataType:0},{dims:r,dataType:e.inputs[0].dataType,gpuDataType:0},{dims:r,dataType:e.inputs[0].dataType,gpuDataType:0}],dispatchGroup:u,programUniforms:d}),getShaderSource:p},{inputs:l,outputs:[-1,-1,-1]})},xp=(e,t)=>{let r=Du(e.inputs,t),[n,i,s]=Fu(e,r);return sn(e,n,i,s,e.inputs[4],void 0,void 0,void 0,e.inputs[5],r)}}),Q0=L(()=>{"use strict";it(),ne(),ie(),Me(),se(),Wu=(e,t)=>{if(!e||e.length!==5)throw new Error("BatchNormalization requires 5 inputs");let r=(n,i,s)=>{let a=i.length;if(a!==n.length)throw new Error(`${s}: num dimensions != ${a}`);i.forEach((u,l)=>{if(u!==n[l])throw new Error(`${s}: dim[${l}] do not match`)})};if(e[0].dims.length>1){let n=t.format==="NHWC"?t.spatial?e[0].dims.slice(-1):e[0].dims.slice(-1).concat(e[0].dims.slice(1,e[0].dims.length-1)):e[0].dims.slice(1,t.spatial?2:void 0);r(e[1].dims,n,"Invalid input scale"),r(e[2].dims,n,"Invalid input B"),r(e[3].dims,n,"Invalid input mean"),r(e[4].dims,n,"Invalid input var")}else r(e[1].dims,[1],"Invalid input scale"),r(e[2].dims,[1],"Invalid input B"),r(e[3].dims,[1],"Invalid input mean"),r(e[4].dims,[1],"Invalid input var")},qu=(e,t)=>{let{epsilon:r,spatial:n,format:i}=t,s=e[0].dims,a=n?Ae(s[s.length-1]):1,u=i==="NHWC"&&s.length>1?a:1,l=O.size(s)/a,d=n,p=d?s.length:s,h=R("x",e[0].dataType,e[0].dims,a),g=R("scale",e[1].dataType,e[1].dims,u),y=R("bias",e[2].dataType,e[2].dims,u),_=R("inputMean",e[3].dataType,e[3].dims,u),b=R("inputVar",e[4].dataType,e[4].dims,u),k=Z("y",e[0].dataType,p,a),v=()=>{let T="";if(n)T=`let cOffset = ${s.length===1?"0u":i==="NHWC"?`outputIndices[${s.length-1}] / ${a}`:"outputIndices[1]"};`;else if(i==="NCHW")T=`
  ...
  }`;return{name:"BatchNormalization",shaderCache:{hint:`${t.epsilon}_${t.format}_${n}_${a}`,inputDependencies:d?["rank","type","type","type","type"]:void 0},getShaderSource:w,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:d?[{type:12,data:l},...te(s)]:[{type:12,data:l}]})}},Gu=e=>ye(e),kp=(e,t)=>{let{inputs:r,outputCount:n}=e,i=Gu({...t,outputCount:n});if(ze.webgpu.validateInputContent&&Wu(r,i),t.trainingMode)throw new Error("BatchNormalization trainingMode is not supported yet.");e.compute(qu(r,i))}}),X0=L(()=>{"use strict";ie(),se(),Vu=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw new Error("number of channels should be 320, 640 or 1280");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Hu=e=>{let t=e[0].dims,r=e[0].dims[2],n=O.size(t)/4,i=e[0].dataType,s=R("input",i,t,4),a=R("bias",i,[r],4),u=R("residual",i,t,4),l=Z("output",i,t,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(n/64)}}),getShaderSource:d=>`
  ...
  }`}},Sp=e=>{Vu(e.inputs),e.compute(Hu(e.inputs))}}),js=L(()=>{"use strict";ne(),ie(),Me(),se(),ju=(e,t,r,n,i,s,a)=>{let u=Math.ceil(t/4),l="";typeof i=="string"?l=`${i}(a)`:l=i("a");let d=R("inputData",r,[u],4),p=Z("outputData",n,[u],4),h=[{name:"vec_size",type:"u32"}];return a&&h.push(...a),`
  ...
  }`},_e=(e,t,r,n,i,s=e.dataType,a,u)=>{let l=[{type:12,data:Math.ceil(O.size(e.dims)/4)}];return a&&l.push(...a),{name:t,shaderCache:{hint:i,inputDependencies:["type"]},getShaderSource:d=>ju(d,O.size(e.dims),e.dataType,s,r,n,u),getRunData:d=>({outputs:[{dims:e.dims,dataType:s}],dispatchGroup:{x:Math.ceil(O.size(d[0].dims)/64/4)},programUniforms:l})}},Tp=e=>{e.compute(_e(e.inputs[0],"Abs","abs"))},Ip=e=>{e.compute(_e(e.inputs[0],"Acos","acos"))},Ep=e=>{e.compute(_e(e.inputs[0],"Acosh","acosh"))},Cp=e=>{e.compute(_e(e.inputs[0],"Asin","asin"))},zp=e=>{e.compute(_e(e.inputs[0],"Asinh","asinh"))},Ap=e=>{e.compute(_e(e.inputs[0],"Atan","atan"))},Mp=e=>{e.compute(_e(e.inputs[0],"Atanh","atanh"))},Op=e=>ye(e),Np=(e,t)=>{let r;switch(t.to){case 10:r="vec4<f16>";break;case 1:r="vec4<f32>";break;case 12:r="vec4<u32>";break;case 6:r="vec4<i32>";break;case 9:r="vec4<bool>";break;default:throw new RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${t.to}`)}e.compute(_e(e.inputs[0],"Cast",r,void 0,t.cacheKey,t.to))},Ku=e=>{let t,r,n=e.length>=2&&e[1].data!==0,i=e.length>=3&&e[2].data!==0;switch(e[0].dataType){case 1:t=n?e[1].getFloat32Array()[0]:-34028234663852886e22,r=i?e[2].getFloat32Array()[0]:34028234663852886e22;break;case 10:t=n?e[1].getUint16Array()[0]:64511,r=i?e[2].getUint16Array()[0]:31743;break;default:throw new Error("Unsupport data type")}return ye({min:t,max:r})},Rp=(e,t)=>{let r=t||Ku(e.inputs),n=Ge(e.inputs[0].dataType);e.compute(_e(e.inputs[0],"Clip",i=>`clamp(${i}, vec4<${n}>(uniforms.min), vec4<${n}>(uniforms.max))`,void 0,r.cacheKey,void 0,[{type:e.inputs[0].dataType,data:r.min},{type:e.inputs[0].dataType,data:r.max}],[{name:"min",type:n},{name:"max",type:n}]),{inputs:[0]})},Bp=e=>{e.compute(_e(e.inputs[0],"Ceil","ceil"))},Dp=e=>{e.compute(_e(e.inputs[0],"Cos","cos"))},Pp=e=>{e.compute(_e(e.inputs[0],"Cosh","cosh"))},Jr=e=>ye(e),Up=(e,t)=>{let r=Ge(e.inputs[0].dataType);e.compute(_e(e.inputs[0],"Elu",n=>`elu_vf32(${n})`,`
...
}`,Lp=e=>{let t=Ge(e.inputs[0].dataType);e.compute(_e(e.inputs[0],"Erf",r=>`erf_vf32(${r})`,Bn(t)))},Fp=e=>{e.compute(_e(e.inputs[0],"Exp","exp"))},Wp=e=>{e.compute(_e(e.inputs[0],"Floor","floor"))},qp=e=>{let t=Ge(e.inputs[0].dataType);e.compute(_e(e.inputs[0],"Gelu",r=>`0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`,Bn(t)))},Gp=(e,t)=>{let r=Ge(e.inputs[0].dataType);e.compute(_e(e.inputs[0],"LeakyRelu",n=>`select(leaky_relu_alpha_ * ${n}, ${n}, ${n} >= vec4<${r}>(0.0))`,`const leaky_relu_alpha_ = ${r}(${t.alpha});`,t.cacheKey))},Vp=e=>{e.compute(_e(e.inputs[0],"Not",t=>`!${t}`))},Hp=e=>{e.compute(_e(e.inputs[0],"Neg",t=>`-${t}`))},jp=e=>{e.compute(_e(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},Kp=e=>{let t=Ge(e.inputs[0].dataType);e.compute(_e(e.inputs[0],"Relu",r=>`select(vec4<${t}>(0.0), ${r}, ${r} > vec4<${t}>(0.0))`))},Qp=e=>{e.compute(_e(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},Xp=e=>ye(e),Zp=(e,t)=>{let r=Ge(e.inputs[0].dataType);e.compute(_e(e.inputs[0],"HardSigmoid",n=>`max(vec4<${r}>(0.0), min(vec4<${r}>(1.0), ${t.alpha} * ${n} + vec4<${r}>(${t.beta})))`,void 0,t.cacheKey))},Yp=e=>{e.compute(_e(e.inputs[0],"Sin","sin"))},Jp=e=>{e.compute(_e(e.inputs[0],"Sinh","sinh"))},eh=e=>{e.compute(_e(e.inputs[0],"Sqrt","sqrt"))},th=e=>{e.compute(_e(e.inputs[0],"Tan","tan"))},Li=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,rh=e=>{e.compute(_e(e.inputs[0],"Tanh",Li))},vs=(e="f32")=>`
...
`,xs=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,nh=e=>{let t=Ge(e.inputs[0].dataType);e.compute(_e(e.inputs[0],"FastGelu",xs,vs(t),void 0,e.inputs[0].dataType))},ih=(e,t)=>{let r=Ge(e.inputs[0].dataType);return e.compute(_e(e.inputs[0],"ThresholdedRelu",n=>`select(vec4<${r}>(0.0), ${n}, ${n} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${r}>(${t.alpha});`,t.cacheKey)),0},sh=e=>{e.compute(_e(e.inputs[0],"Log","log"))},Qu=(e,t)=>`
...
`,Xu=e=>`quick_gelu_impl(${e})`,ah=(e,t)=>{let r=Ge(e.inputs[0].dataType);e.compute(_e(e.inputs[0],"QuickGelu",Xu,Qu(r,t.alpha),t.cacheKey,e.inputs[0].dataType))}}),Z0=L(()=>{"use strict";ie(),se(),js(),Zu=e=>{if(e[0].dims.length!==3)throw new Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw new Error("hidden state should be 2560, 5120 or 10240");if(e[1].dims.length!==1)throw new Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw new Error("last dimension of input and bias are not the same")},Yu=e=>{let t=e[0].dims.slice();t[2]=t[2]/2;let r=R("input",e[0].dataType,e[0].dims,4),n=R("bias",e[0].dataType,[e[0].dims[2]],4),i=Z("output",e[0].dataType,t,4),s=O.size(t)/4,a=De(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:t,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)}}),getShaderSource:u=>`
  ...
  ${u.mainStart()}
    ...
    ${i.setByOffset("global_idx","valueLeft * geluRight")}
        ...
        ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
        ${v}
      }`},el=(e,t,r,n,i,s,a=r.dataType)=>{let u=r.dims.map(Number),l=n.dims.map(Number),d=!O.areEqual(u,l),p=u,h=O.size(u),g=!1,y=!1,_=[d];if(d){let b=Sr.calcShape(u,l,!1);if(!b)throw new Error("Can't perform binary op on the given tensors");p=b.slice(),h=O.size(p);let k=O.size(u)===1,v=O.size(l)===1,w=u.length>0&&u[u.length-1]%4===0,T=l.length>0&&l[l.length-1]%4===0;_.push(k),_.push(v),_.push(w),_.push(T);let S=1;for(let I=1;I<p.length;I++){let C=u[u.length-I],A=l[l.length-I];if(C===A)S*=C;else break}S%4===0?(y=!0,g=!0):(k||v||w||T)&&(g=!0)}else g=!0;return _.push(g),{name:e,shaderCache:{hint:t+_.map(b=>b.toString()).join("_"),inputDependencies:["rank","rank"]},getShaderSource:b=>Ju(b,u,l,p,g,d,y,i,r.dataType,n.dataType,a,s),getRunData:()=>({outputs:[{dims:p,dataType:a}],dispatchGroup:{x:Math.ceil(h/64/4)},programUniforms:[{type:12,data:Math.ceil(O.size(p)/4)},...te(u,l,p)]})}},pt=(e,t,r,n,i,s)=>{e.compute(el(t,i??"",e.inputs[0],e.inputs[1],r,n,s))},uh=e=>{pt(e,"Add",(t,r)=>`${t}+${r}`)},lh=e=>{pt(e,"Div",(t,r)=>`${t}/${r}`)},dh=e=>{pt(e,"Equal",{scalar:(t,r)=>`u32(${t}==${r})`,vector:(t,r)=>`vec4<u32>(${t}==${r})`},void 0,void 0,9)},ch=e=>{pt(e,"Mul",(t,r)=>`${t}*${r}`)},ph=e=>{let t=R("input",e.inputs[0].dataType,e.inputs[0].dims).type.value;pt(e,"Pow",{scalar:(r,n)=>`pow_custom(${r},${n})`,vector:(r,n)=>`pow_vector_custom(${r},${n})`},`
    ...
    fn pow_vector_custom(a : vec4<${t}>, b : vec4<${t}>) -> vec4<${t}> {
      ...
      `)},hh=e=>{pt(e,"Sub",(t,r)=>`${t}-${r}`)},fh=e=>{pt(e,"Greater",{scalar:(t,r)=>`u32(${t}>${r})`,vector:(t,r)=>`vec4<u32>(${t}>${r})`},void 0,void 0,9)},mh=e=>{pt(e,"Less",{scalar:(t,r)=>`u32(${t}<${r})`,vector:(t,r)=>`vec4<u32>(${t}<${r})`},void 0,void 0,9)},gh=e=>{pt(e,"GreaterOrEqual",{scalar:(t,r)=>`u32(${t}>=${r})`,vector:(t,r)=>`vec4<u32>(${t}>=${r})`},void 0,void 0,9)},_h=e=>{pt(e,"LessOrEqual",{scalar:(t,r)=>`u32(${t}<=${r})`,vector:(t,r)=>`vec4<u32>(${t}<=${r})`},void 0,void 0,9)}}),J0=L(()=>{"use strict";ne(),ie(),Me(),se(),tl=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");let r=0,n=e[r],i=n.dataType,s=n.dims.length;e.forEach((a,u)=>{if(u!==r){if(a.dataType!==i)throw new Error("input tensors should be one type");if(a.dims.length!==s)throw new Error("input tensors should have the same shape");a.dims.forEach((l,d)=>{if(d!==t&&l!==n.dims[d])throw new Error("non concat dimensions must match")})}})},rl=(e,t)=>`
  fn calculateInputIndex(index: u32) -> u32 {
    ...
    return ${e}u;
  }`,nl=(e,t)=>{let r=e.length,n=[];for(let i=0;i<r;++i){let s=t.setByOffset("global_idx",e[i].getByIndices("indices"));r===1?n.push(s):i===0?n.push(`if (inputIndex == ${i}u) { ${s} }`):i===r-1?n.push(`else { ${s} }`):n.push(`else if (inputIndex == ${i}) { ${s} }`)}return n.join(`
`)},il=(e,t,r,n)=>{let i=O.size(r),s=new Array(e.length),a=new Array(e.length),u=0,l=[],d=[],p=[{type:12,data:i}];for(let b=0;b<e.length;++b)u+=e[b].dims[t],s[b]=u,d.push(e[b].dims.length),a[b]=R(`input${b}`,n,d[b]),l.push("rank"),p.push({type:12,data:s[b]});for(let b=0;b<e.length;++b)p.push(...te(e[b].dims));p.push(...te(r));let h=Z("output",n,r.length),g=h.indicesGet("indices",t),y=Array.from(Array(s.length).keys()).map(b=>`uniforms.sizeInConcatAxis${b}`).join(","),_=b=>`
  ...
  ${b.mainStart()}
    ...
    ${nl(a,h)}
  }`;return{name:"Concat",shaderCache:{hint:`${t}`,inputDependencies:l},getRunData:()=>({outputs:[{dims:r,dataType:n}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:p}),getShaderSource:_}},yh=(e,t)=>{let r=e.inputs,n=r[0].dims,i=O.normalizeAxis(t.axis,n.length);tl(r,i);let s=n.slice();s[i]=r.reduce((u,l)=>u+(l.dims.length>i?l.dims[i]:0),0);let a=r.filter(u=>O.size(u.dims)>0);e.compute(il(a,i,s,r[0].dataType),{inputs:a})},wh=e=>ye({axis:e.axis})}),_r=L(()=>{"use strict";ne(),ie(),hr=(e,t,r="f32")=>{switch(e.activation){case"Relu":return`value = max(value, ${t}(0.0));`;case"Sigmoid":return`value = (${t}(1.0) / (${t}(1.0) + exp(-value)));`;case"Clip":return`value = clamp(value, ${t}(${r}(uniforms.clip_min)), ${t}(${r}(uniforms.clip_max)));`;case"HardSigmoid":return`value = max(${t}(0.0), min(${t}(1.0), ${r}(uniforms.alpha) * value + ${r}(uniforms.beta)));`;case"LeakyRelu":return`value = select(${r}(uniforms.alpha) * value, value, value >= ${t}(0.0));`;case"Tanh":return`let e2x = exp(-2.0 * abs(value));
              value = sign(value) * (1.0 - e2x) / (1.0 + e2x);
        `;case"":return"";default:throw new Error(`Unsupported activation ${e.activation}`)}},fr=(e,t)=>{e.activation==="Clip"?t.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):e.activation==="HardSigmoid"?t.push({type:1,data:e.alpha},{type:1,data:e.beta}):e.activation==="LeakyRelu"&&t.push({type:1,data:e.alpha})},mr=(e,t)=>{e.activation==="Clip"?t.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):e.activation==="HardSigmoid"?t.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):e.activation==="LeakyRelu"&&t.push({name:"alpha",type:"f32"})},Ks=e=>{let t=e?.activation||"";if(t==="HardSigmoid"){let[r,n]=e?.activation_params||[.2,.5];return{activation:t,alpha:r,beta:n}}else if(t==="Clip"){let[r,n]=e?.activation_params||[Vc,Hc];return{activation:t,clipMax:n,clipMin:r}}else if(t==="LeakyRelu"){let[r]=e?.activation_params||[.01];return{activation:t,alpha:r}}return{activation:t}}}),Qs=L(()=>{"use strict";Le=(e,t)=>{switch(e){case 1:return t;case 2:return`vec2<${t}>`;case 3:return`vec3<${t}>`;case 4:return`vec4<${t}>`;default:throw new Error(`${e}-component is not supported.`)}},bh=e=>`
...
`}return z};return`
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${h};${g};${y};${i}`,inputDependencies:b?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:s?s(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(_/64)},programUniforms:w}),getShaderSource:T}}}),Ys=L(()=>{"use strict";ne(),ie(),se(),_r(),Zs(),Qs(),sl=(e,t)=>e?`
...
`},ul=(e,t,r,n,i=!1)=>{let[s,a,u,l]=n,d=De(n[0].type.tensor);return`
  ...
  ${b?ks(k,v,P,z):Ss(k,v,P,z)}
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${I}) {
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${b?`vec4<${V}>`:V}) {
        ...
        ${$h("uniforms.result_strides")}
        //struct Uniforms { xShape : vec4<i32>, wShape : vec4<i32>, outShape : vec4<i32>,
        //  outShapeStrides: vec3<i32>, filterDims : vec2<i32>, pad : vec2<i32>, stride : vec2<i32>,
        //  dilation : vec2<i32>, dimAOuter : i32, dimBOuter : i32, dimInner : i32 };
        ${P.registerUniforms(ee).declareVariables(...K,re)}
        ${oe}
        ${ll(d,B,U,H,a,t,W[0],W[1],W[2],V)}
        ${b?ks(T,w,V,void 0,!d,$):Ss(T,w,V,void 0,!d,$,!1,void 0,u)}`};return{name:"Conv2DMatMul",shaderCache:{hint:`${t.cacheKey};${I};${b};${B};${U};${H};${C};${A};${$}`,inputDependencies:j},getRunData:()=>({outputs:[{dims:l?l(r):r,dataType:e[0].dataType}],dispatchGroup:{x:S[0],y:S[1],z:S[2]},programUniforms:G}),getShaderSource:z}}}),r_=L(()=>{"use strict";ne(),Ot(),ie(),se(),_r(),Qs(),dl=e=>{let t=1;for(let r=0;r<e.length;r++)t*=e[r];return t},Wi=e=>typeof e=="number"?[e,e,e]:e,Vr=(e,t)=>t<=1?e:e+(e-1)*(t-1),cl=(e,t,r,n=1)=>{let i=Vr(t,n);return Math.floor((e[0]*(r-1)-r+i)/2)},qi=(e,t,r,n,i)=>{i==null&&(i=cl(e,t[0],n[0]));let s=[0,0,0,r];for(let a=0;a<3;a++)e[a]+2*i>=t[a]&&(s[a]=Math.trunc((e[a]-t[a]+2*i)/n[a]+1));return s},pl=(e,t,r,n,i,s,a,u,l,d)=>{let p,h,g,y;if(e==="VALID"&&(e=0),typeof e=="number"){p={top:e,bottom:e,left:e,right:e,front:e,back:e};let _=qi([t,r,n,1],[u,l,d],1,[i,s,a],e);h=_[0],g=_[1],y=_[2]}else if(Array.isArray(e)){if(!e.every((b,k,v)=>b===v[0]))throw Error(`Unsupported padding parameter: ${e}`);p={top:e[0],bottom:e[1],left:e[2],right:e[3],front:e[4],back:e[5]};let _=qi([t,r,n,1],[u,l,d],1,[i,s,a],e[0]);h=_[0],g=_[1],y=_[2]}else if(e==="SAME_UPPER"){h=Math.ceil(t/i),g=Math.ceil(r/s),y=Math.ceil(n/a);let _=(h-1)*i+u-t,b=(g-1)*s+l-r,k=(y-1)*a+d-n,v=Math.floor(_/2),w=_-v,T=Math.floor(b/2),S=b-T,I=Math.floor(k/2),C=k-I;p={top:T,bottom:S,left:I,right:C,front:v,back:w}}else throw Error(`Unknown padding parameter: ${e}`);return{padInfo:p,outDepth:h,outHeight:g,outWidth:y}},xh=(e,t,r,n,i,s=!1,a="channelsLast")=>{let u,l,d,p,h;if(a==="channelsLast")[u,l,d,p,h]=e;else if(a==="channelsFirst")[u,h,l,d,p]=e;else throw new Error(`Unknown dataFormat ${a}`);let[g,,y,_,b]=t,[k,v,w]=Wi(r),[T,S,I]=Wi(n),C=Vr(y,T),A=Vr(_,S),$=Vr(b,I),{padInfo:B,outDepth:U,outHeight:H,outWidth:W}=pl(i,l,d,p,k,v,w,C,A,$),G=s?g*h:g,j=[0,0,0,0,0];return a==="channelsFirst"?j=[u,G,U,H,W]:a==="channelsLast"&&(j=[u,U,H,W,G]),{batchSize:u,dataFormat:a,inDepth:l,inHeight:d,inWidth:p,inChannels:h,outDepth:U,outHeight:H,outWidth:W,outChannels:G,padInfo:B,strideDepth:k,strideHeight:v,strideWidth:w,filterDepth:y,filterHeight:_,filterWidth:b,effectiveFilterDepth:C,effectiveFilterHeight:A,effectiveFilterWidth:$,dilationDepth:T,dilationHeight:S,dilationWidth:I,inShape:e,outShape:j,filterShape:t}},kh=(e,t,r,n,i,s)=>{let a=s==="channelsLast",u=a?e[0].dims[3]:e[0].dims[1],l=!1,d=[64,1,1],p={x:r.map((w,T)=>T)},h=[Math.ceil(dl(p.x.map(w=>r[w]))/d[0]),1,1];me("verbose",()=>`[conv3d_naive_webgpu] dispatch = ${h}`);let g=l?a&&u%4!==0?3:4:1,y=O.size(r),_=[{type:12,data:y},{type:12,data:n},{type:12,data:i},{type:12,data:t.strides},{type:12,data:t.dilations}];fr(t,_),_.push(...te(e[0].dims,e[1].dims));let b=["rank","rank"],k=e.length===3;k&&(_.push(...te(e[2].dims)),b.push("rank")),_.push(...te(r));let v=w=>{let T=[{name:"output_size",type:"u32"},{name:"filter_dims",type:"u32",length:n.length},{name:"pads",type:"u32",length:i.length},{name:"strides",type:"u32",length:t.strides.length},{name:"dilations",type:"u32",length:t.dilations.length}];mr(t,T);let S=l?4:1,I=De(e[0].dataType),C=R("x",e[0].dataType,e[0].dims.length,g===3?1:g),A=R("W",e[1].dataType,e[1].dims.length,S),$=[C,A],B=Z("result",e[0].dataType,r.length,S),U="";if(k){let G=R("bias",e[2].dataType,e[2].dims.length,S);$.push(G),U+=`
  ...
  ${_.mainStart()}
    ...
    ${F}}`};return{name:"ConvTranspose2D",shaderCache:{hint:`${t.cacheKey};${p}${b}${_}${h}${y}`,inputDependencies:w},getRunData:()=>({dispatchGroup:{x:v[0],y:v[1],z:v[2]},outputs:[{dims:r?r(i):i,dataType:e[0].dataType}],programUniforms:$}),getShaderSource:B}}}),a_=L(()=>{"use strict";s_(),_r(),Yt(),_l=(e,t,r,n,i,s)=>(e-1)*t+r+(n-1)*i+1-s,yl=(e,t,r,n,i)=>{let s=Math.floor(e/2);t==="SAME_UPPER"?(r[n]=s,r[i]=e-s):t==="SAME_LOWER"&&(r[n]=e-s,r[i]=s)},wl=(e,t,r,n,i,s,a,u,l,d)=>{let p=e.length-2,h=d.length===0;l.length<p&&l.push(...Array(p-l.length).fill(0));let g=e[0],y=t[u?3:1]*i;for(let _=0,b=e.length-p-(u?1:0);_<p;++_,++b){let k=e[b],v=h?k*a[_]:d[_],w=_l(k,a[_],s[_],t[b],r[_],v);yl(w,n,s,_,_+p),h&&d.push(a[_]*(k-1)+l[_]+(t[b]-1)*r[_]+1-s[_]-s[_+p])}d.splice(0,0,g),d.splice(u?3:1,0,y)},Vi=(e,t)=>{let r=e.kernelShape.slice();if(e.kernelShape.length===0||e.kernelShape.reduce((h,g)=>h*g,1)===0){r.length=0;for(let h=2;h<t[1].dims.length;++h)r.push(t[1].dims[h])}let n=e.format==="NHWC";r.splice(0,0,t[1].dims[0]),r.splice(n?3:1,0,t[1].dims[1]);let i=e.pads.slice(),s=e.outputShape.slice(),a=e.outputPadding.slice(),u=t[0].dims,l=e.dilations.slice();if(l.reduce((h,g)=>h+g,0)===0){let h=t[0].dims.length-2;l=new Array(h).fill(1)}let d=e.strides.slice();if(d.reduce((h,g)=>h+g,0)===0){let h=t[0].dims.length-2;d=new Array(h).fill(1)}wl(u,r,l,e.autoPad,e.group,i,d,n,a,s);let p=Object.assign({},e);return Object.assign(p,{kernelShape:r,pads:i,outputPadding:a,outputShape:s,dilations:l,strides:d}),p},Eh=e=>{let t=Ks(e),r=e.format,n=["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][typeof e.autoPad>"u"?0:e.autoPad],i=e.dilations,s=e.group,a=e.kernelShape,u=e.pads,l=e.strides,d=e.wIsConst(),p=e.outputPadding,h=e.outputShape;return{autoPad:n,format:r,dilations:i,group:s,kernelShape:a,outputPadding:p,outputShape:h,pads:u,strides:l,wIsConst:d,...t,cacheKey:`${e.format};${t.activation};`}},bl=(e,t)=>{if(!e||e.length!==2&&e.length!==3)throw new Error("Conv requires 2 or 3 inputs");if(e[0].dims.length!==4&&e[0].dims.length!==3)throw new Error("currently only support 2-dimensional conv");if(e[0].dims.length!==e[1].dims.length)throw new Error("filter does not have same dimension as input");let r=e[0].dims[t.format==="NHWC"?e[0].dims.length-1:1],n=e[1].dims[0];if(r!==n)throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");let i=e[1].dims[1]*t.group;if(e.length===3&&(e[2].dims.length!==1||e[2].dims[0]!==i))throw new Error("invalid bias");let s=e[0].dims.length-2;if(t.dilations.reduce((a,u)=>a+u,0)>0&&t.dilations.length!==s)throw new Error(`dilations should be ${s}D`);if(t.strides.reduce((a,u)=>a+u,0)>0&&t.strides.length!==s)throw new Error(`strides should be ${s}D`);if(t.pads.reduce((a,u)=>a+u,0)>0&&t.pads.length!==s*2)throw new Error(`pads should be ${s*2}D`);if(t.outputPadding.length!==s&&t.outputPadding.length!==0)throw new Error(`output_padding should be ${s}D`);if(t.kernelShape.reduce((a,u)=>a+u,0)>0&&t.kernelShape.length!==0&&t.kernelShape.length!==e[1].dims.length-2)throw new Error("invalid kernel shape");if(t.outputShape.length!==0&&t.outputShape.length!==e[0].dims.length-2)throw new Error("invalid output shape")},Hi=(e,t,r,n)=>{let i=e.kernelCustomData.wT??e.compute(Je(t[1],[2,3,0,1]),{inputs:[1],outputs:[r.wIsConst?-2:-1]})[0];r.wIsConst&&!e.kernelCustomData.wT&&(e.kernelCustomData.wT=i);let s=[t[0],i];t.length===3&&s.push(t[2]),e.compute(Ih(s,r,n),{inputs:s})},$l=(e,t)=>{let r=t.format==="NHWC",n=[e.inputs[0].reshape(r?[e.inputs[0].dims[0],1,e.inputs[0].dims[1],e.inputs[0].dims[2]]:[e.inputs[0].dims[0],e.inputs[0].dims[1],1,e.inputs[0].dims[2]]),e.inputs[1].reshape([e.inputs[1].dims[0],e.inputs[1].dims[1],1,e.inputs[1].dims[2]])];e.inputs.length===3&&n.push(e.inputs[2]);let i=t.kernelShape;(i.length===0||i[0]===0)&&(i=[e.inputs[1].dims[2]]);let s=t.dilations;(s.length===0||s[0]===0)&&(s=[1]);let a=t.strides;(a.length===0||a[0]===0)&&(a=[1]);let u=t.pads;u.length===0&&(u=[0,0]),u=[0,u[0],0,u[1]],a=[1].concat(a),s=[1].concat(s),i=[1].concat(i);let l=t.outputPadding;l=[0].concat(l);let d=Vi({...t,pads:u,strides:a,dilations:s,kernelShape:i,outputPadding:l},n);Hi(e,n,d,p=>r?[p[0],p[2],p[3]]:[p[0],p[1],p[3]])},Ch=(e,t)=>{if(bl(e.inputs,t),e.inputs[0].dims.length===3)$l(e,t);else{let r=Vi(t,e.inputs);Hi(e,e.inputs,r)}}}),o_=L(()=>{"use strict";ne(),ie(),Me(),se(),vl=(e,t,r,n)=>{let i=O.size(t),s=t.length,a=R("input",e,s),u=Z("output",e,s),l=r.dataType===6?r.getInt32Array()[0]:Number(r.getBigInt64Array()[0]),d=O.normalizeAxis(l,s),p=h=>{let g=` i32(${a.indicesGet("inputIndices","uniforms.axis")}) `,y=J("uniforms.input_shape","uniforms.axis",s),_=n.reverse?g+(n.exclusive?" + 1":""):"0",b=n.reverse?y:g+(n.exclusive?"":" + 1");return`
                ...
                }`};return{name:"CumSum",shaderCache:{hint:n.cacheKey,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:t,dataType:e}],dispatchGroup:{x:Math.ceil(i/64)},programUniforms:[{type:12,data:i},{type:12,data:d},...te(t,t)]}),getShaderSource:p}},zh=(e,t)=>{let r=e.inputs[0].dims,n=e.inputs[0].dataType,i=e.inputs[1];e.compute(vl(n,r,i,t),{inputs:[0]})},Ah=e=>{let t=e.exclusive===1,r=e.reverse===1;return ye({exclusive:t,reverse:r})}}),u_=L(()=>{"use strict";ne(),ie(),Me(),se(),xl=e=>{if(!e||e.length!==1)throw new Error("DepthToSpace requires 1 input.");if(e[0].dims.length!==4)throw new Error("DepthToSpace requires 4D input.")},kl=(e,t,r,n)=>{let i=[];i.push(`fn perm(i: ${n.type.indices}) -> ${r.type.indices} {
    var a: ${r.type.indices};`);for(let s=0;s<t;++s)i.push(r.indicesSet("a",e[s],`i[${s}]`));return i.push("return a;}"),i.join(`
`)},Sl=(e,t)=>{let r,n,i,s,a,u,l=t.format==="NHWC",d=t.blocksize,p=t.mode==="DCR";l?([r,n,i,s]=e.dims,a=p?[r,n,i,d,d,s/d**2]:[r,n,i,s/d**2,d,d],u=p?[0,1,3,2,4,5]:[0,1,4,2,5,3]):([r,n,i,s]=[e.dims[0],e.dims[2],e.dims[3],e.dims[1]],a=p?[r,d,d,s/d**2,n,i]:[r,s/d**2,d,d,n,i],u=p?[0,3,4,1,5,2]:[0,1,4,2,5,3]);let h=e.reshape(a),g=h.dims.length,y=e.dataType,_=R("a",y,g),b=Z("output",y,g),k=v=>`
...
`)};
          ...
          }`};return{name:"Einsum",shaderCache:{hint:r.equation,inputDependencies:e.map(()=>"rank")},getRunData:()=>{let d=u.filter(h=>r.symbolToInfo.has(h)).map(h=>({type:12,data:r.symbolToInfo.get(h)?.dimValue||0}));d.push({type:12,data:s});let p=e.map((h,g)=>[...te(h)]).reduce((h,g)=>h.concat(g),d);return p.push(...te(n)),{outputs:[{dims:n,dataType:t}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:p}},getShaderSource:l}},Nh=(e,t)=>{let r=new Cl(e.inputs,t.equation),n=r.outputDims,i=e.inputs.map((s,a)=>s.dims);e.compute(zl(i,e.inputs[0].dataType,r,n))},Rh=e=>{let t=e.equation.replace(/\s+/g,"");return ye({equation:t})}}),d_=L(()=>{"use strict";ne(),ie(),se(),Al=e=>{if(!e||e.length!==2)throw new Error("Expand requires 2 input.");let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),n=r.length<t.length?0:r.length-t.length,i=t.length<r.length?0:t.length-r.length;for(;n<r.length&&i<t.length;++n,++i)if(r[n]!==t[i]&&r[n]!==1&&t[i]!==1)throw new Error("Expand requires shape to be broadcastable to input")},Qi=(e,t)=>{let r=e.length-t.length,n=[];for(let i=0;i<r;++i)n.push(e[i]);for(let i=0;i<t.length;++i)n.push(t[i]===1?e[i+r]:t[i]);return n},Ml=(e,t)=>e.length>t.length?Qi(e,t):Qi(t,e),Ol=e=>{let t=e[0].dims,r=Array.from(e[1].getBigInt64Array(),Number),n=Ml(t,r),i=e[0].dataType,s=i===9||O.size(t)===1,a=i===9||t.length>0&&t[t.length-1]%4===0?4:1,u=s||n.length>0&&n[n.length-1]%4===0?4:1,l=Math.ceil(O.size(n)/u),d=h=>{let g=R("input",i,t.length,a),y=Z("output",i,n.length,u),_;if(i===9){let b=(k,v,w="")=>`
    ...
    ${_}`},p=[{type:12,data:l},...te(t,n)];return{name:"Expand",shaderCache:{hint:`${n.length};${a}${u}`,inputDependencies:["rank"]},getShaderSource:d,getRunData:()=>({outputs:[{dims:n,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:p})}},Bh=e=>{Al(e.inputs),e.compute(Ol(e.inputs),{inputs:[0]})}}),c_=L(()=>{"use strict";ne(),ie(),se(),js(),Nl=e=>{let t=e[0].dataType,r=O.size(e[0].dims),n=O.size(e[1].dims),i=n%4===0,s=a=>{let u=R("x",t,[1],4),l=R("bias",t,[1],4),d=Z("y",t,[1],4),p=[{name:"output_vec_size",type:"u32"},{name:"bias_size",type:"u32"}],h=y=>`
    ...
    ${a.mainStart(Tr)}
      ...
      ${g.mainStart()}
        ...
        ${v}
      }`};return{name:"Gather",shaderCache:{hint:t.cacheKey,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:p}),getShaderSource:h}},Ph=e=>ye({axis:e.axis}),Uh=(e,t)=>{let r=e.inputs;Rl(r),e.compute(Bl(e.inputs,t))}}),h_=L(()=>{"use strict";ne(),ie(),se(),Dl=(e,t,r,n,i,s,a,u,l)=>{let d=[{type:12,data:s},{type:12,data:n},{type:12,data:i},{type:12,data:r},{type:12,data:a},{type:12,data:u},{type:12,data:l}],p=[s];d.push(...te(t.dims,p));let h=g=>{let y=R("indices_data",t.dataType,t.dims.length),_=Z("input_slice_offsets_data",12,1,1),b=[y,_],k=[{name:"output_size",type:"u32"},{name:"batch_dims",type:"u32"},{name:"input_dims",type:"u32",length:i.length},{name:"sizes_from_slice_dims_data",type:"u32",length:r.length},{name:"num_slices_per_batch",type:"u32"},{name:"input_batch_stride",type:"u32"},{name:"num_slice_dims",type:"u32"}];return`
  ...
  ${g.mainStart()}
    ...
    }`};return{name:"GatherBlockQuantized",shaderCache:{hint:`${t.cacheKey};${e.filter((y,_)=>_!==1).map(y=>y.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:e.length},(y,_)=>"rank")},getRunData:()=>({outputs:[{dims:u,dataType:d}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:h}),getShaderSource:g}},Wh=(e,t)=>{let r=e.inputs;Pl(r,t),e.compute(Ul(e.inputs,t))},qh=e=>ye({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})}),m_=L(()=>{"use strict";ne(),ie(),Me(),se(),Ll=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
                     indices input tensors be of same rank.`)},Fl=(e,t)=>{let r=e[0].dims,n=e[0].dataType,i=r.length,s=e[1].dims,a=e[1].dataType,u=O.normalizeAxis(t.axis,i),l=r[u],d=s.slice(0),p=O.size(d),h=R("input",n,i),g=R("indicesInput",a,s.length),y=Z("output",n,d.length),_=[{type:12,data:p},{type:6,data:l},{type:12,data:u}];return _.push(...te(r,s,d)),{name:"GatherElements",shaderCache:{inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:d,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:_}),getShaderSource:b=>`
  ...
  }`};return h?{name:"GemmShared",shaderCache:{hint:`${t.cacheKey}`,inputDependencies:_},getRunData:()=>({outputs:[{dims:u,dataType:e[0].dataType}],dispatchGroup:{x:d*p},programUniforms:y}),getShaderSource:k}:{name:"Gemm",shaderCache:{hint:`${t.cacheKey}`,inputDependencies:_},getRunData:()=>({outputs:[{dims:u,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(g/64)},programUniforms:y}),getShaderSource:b}},Hh=e=>{let t=e.transA,r=e.transB,n=e.alpha,i=e.beta;return{transA:t,transB:r,alpha:n,beta:i,cacheKey:`${e.transA};${e.transB};${e.alpha===1}`}},jh=(e,t)=>{Wl(e.inputs),e.compute(ql(e.inputs,t))}}),__=L(()=>{"use strict";ne(),ie(),Me(),se(),[St,At,sr,ar]=[0,1,2,3],Gl=e=>{if(e[0].dims.length!==4)throw new Error("only 4-D tensor is supported.");if(e[0].dims.length!==e[1].dims.length)throw new Error("input dimensions must be equal to grid dimensions");if(e[0].dims.length-2!==e[1].dims[e[1].dims.length-1])throw new Error(`last dimension of grid must be equal to ${e[0].dims.length-2}`);if(e[0].dims[0]!==e[1].dims[0])throw new Error("grid batch size must match input batch size")},Vl=`
...
`,Xl=(e,t,r)=>(()=>{switch(r.mode){case"nearest":return`
        ...
        `;default:throw new Error(`mode ${r.mode} is not supported`)}})()+`${e.setByOffset("global_idx","result")}`,Zl=(e,t)=>{let r=R("x",e[0].dataType,e[0].dims.length),n=[e[1].dims[0],e[1].dims[1],e[1].dims[2]],i=R("grid",e[1].dataType,n.length,2),s=[e[0].dims[0],e[0].dims[1],e[1].dims[1],e[1].dims[2]];t.format==="NHWC"&&(s=[e[0].dims[0],e[1].dims[1],e[1].dims[2],e[0].dims[3]],[St,At,sr,ar]=[0,3,1,2]);let a=Z("output",e[0].dataType,s.length),u=r.type.value,l=O.size(s),d=[{type:12,data:l},...te(e[0].dims,n,s)],p=h=>`
  ...
  }`};return e.compute({name:"MultiHeadAttentionAddBias",shaderCache:{inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:u,dataType:t.dataType,gpuDataType:0}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:d}),getShaderSource:p},{inputs:[t,r],outputs:[-1]})[0]},en=(e,t,r,n,i,s,a,u)=>{let l=s;if(a&&O.size(a.dims)>0){if(n===1)throw new Error("AddBiasReshape is not implemented. Please export your model with packed QKV or KV");return l=Jl(e,s,a,t,n,r*i,u),l=l.reshape([t,n,r,i]),r===1||n===1?l:e.compute(Je(l,Xi.perm),{inputs:[l],outputs:[-1]})[0]}else return s.dims.length===3&&(l=s.reshape([t,n,r,i])),r===1||n===1?l:e.compute(Je(l,Xi.perm),{inputs:[l],outputs:[-1]})[0]},Zh=(e,t)=>{let r=Yl(e.inputs,t),n=e.inputs[0],i=He(e.inputs,1),s=He(e.inputs,2),a=He(e.inputs,3),u=He(e.inputs,4),l=He(e.inputs,5),d=He(e.inputs,6),p=He(e.inputs,7);if(n.dims.length===5)throw new Error("Packed QKV is not implemented");if(i?.dims.length===5)throw new Error("Packed KV is not implemented");let h=i&&s&&i.dims.length===4&&s.dims.length===4,g=en(e,r.batchSize,r.numHeads,r.sequenceLength,r.headSize,n,a,0);if(h)return sn(e,g,i,s,u,void 0,d,p,l,r);if(!i||!s)throw new Error("key and value must be provided");let y=en(e,r.batchSize,r.numHeads,r.kvSequenceLength,r.headSize,i,a,r.hiddenSize),_=en(e,r.batchSize,r.numHeads,r.kvSequenceLength,r.vHeadSize,s,a,2*r.hiddenSize);sn(e,g,y,_,u,void 0,d,p,l,r)}}),tf=L(()=>{"use strict";ne(),ie(),Me(),se(),ed=e=>{if(!e||e.length<1)throw new Error("too few inputs")},td=(e,t)=>{let r=[],n=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(i=>r.push(Number(i))),n=r.length),ye({numOutputs:n,axis:t.axis,splitSizes:r})},rd=e=>`
fn calculateOutputIndex(index: u32) -> u32 {
    ...
    return ${e}u;
}`,nd=e=>{let t=e.length,r=[];for(let n=0;n<t;++n){let i=e[n].setByIndices("indices","input[global_idx]");t===1?r.push(i):n===0?r.push(`if (output_number == ${n}u) { ${i} }`):n===t-1?r.push(`else { ${i} }`):r.push(`else if (output_number == ${n}) { ${i} }`)}return`
...
`)}
  ...
  `};return{name:"GeneratePositionIds",shaderCache:{hint:`${e};${t}`,inputDependencies:s},getRunData:()=>({outputs:[{dims:a,dataType:i}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:l}),getShaderSource:d}},sf=(e,t)=>{let r=sd(e.inputs,t);if(e.inputs[0].dims.length===5)throw new Error("Packed QKV is not implemented");if(e.inputs[1]?.dims.length===5)throw new Error("Packed KV is not implemented");let n=e.inputs[0],i=e.inputs[1]&&e.inputs[1].dims.length>0?e.inputs[1]:void 0,s=e.inputs[2]&&e.inputs[2].dims.length>0?e.inputs[2]:void 0,a=e.inputs[3]&&e.inputs[3].dims.length!==0?e.inputs[3]:void 0,u=e.inputs[4]&&e.inputs[4].dims.length!==0?e.inputs[4]:void 0,l=e.inputs.length>4?e.inputs[5]:void 0,d=e.inputs.length>5?e.inputs[6]:void 0,p=r.kvNumHeads?r.kvNumHeads:r.numHeads,h=ye({axis:2,numOutputs:3,splitSizes:[r.numHeads*r.headSize,p*r.headSize,p*r.headSize]}),[g,y,_]=!i&&!s?e.compute(Es([n],h),{inputs:[n],outputs:[-1,-1,-1]}):[n,i,s],b,k;if(t.doRotary){let S=e.compute(od(r.batchSize,r.sequenceLength,l,d),{inputs:[l,d],outputs:[-1]})[0],I=e.inputs[7],C=e.inputs[8],A=ye({interleaved:t.rotaryInterleaved!==0,numHeads:r.numHeads,rotaryEmbeddingDim:0,scale:t.scale}),$=[g,S,I,C],B=[-1];b=e.compute(Wn($,A),{inputs:$,outputs:B})[0],$.splice(0,1,y);let U=ye({interleaved:t.rotaryInterleaved!==0,numHeads:r.kvNumHeads,rotaryEmbeddingDim:0,scale:t.scale});k=e.compute(Wn($,U),{inputs:$,outputs:B})[0]}let v=en(e,r.batchSize,r.numHeads,r.sequenceLength,r.headSize,t.doRotary?b:g,void 0,0),w=Zi(e,t.doRotary?k:y,r),T=Zi(e,_,r);sn(e,v,w,T,void 0,void 0,a,u,void 0,r,l,d)}}),w_=L(()=>{"use strict";ne(),ie(),Yt(),se(),Yi=(e,t,r,n,i,s,a,u)=>{let l=Ae(s),d=l===1?"f32":`vec${l}f`,p=l===1?"vec2f":`mat2x${l}f`,h=i*a,g=64;h===1&&(g=256);let y=[i,a,s/l],_=[i,a,2],b=["rank","type","type"],k=[];k.push(...te(y,_));let v=w=>{let T=R("x",t.dataType,3,l),S=R("scale",r.dataType,r.dims),I=R("bias",n.dataType,n.dims),C=Z("output",1,3,2),A=[T,S,I,C];return`
  ...
  }`};e.compute({name:"InstanceNormalizationNHWC",shaderCache:{hint:`${l}`,inputDependencies:h},getRunData:()=>({outputs:[{dims:i,dataType:t[0].dataType}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:p}),getShaderSource:k},{inputs:[t[0],b]})},af=(e,t)=>{t.format==="NHWC"?ld(e,e.inputs,t):ud(e,e.inputs,t)}}),b_=L(()=>{"use strict";ne(),ie(),se(),dd=e=>{if(!e||e.length<2)throw new Error("layerNorm requires at least 2 inputs.")},cd=(e,t,r)=>{let n=t.simplified,i=e[0].dims,s=e[1],a=!n&&e[2],u=i,l=O.normalizeAxis(t.axis,i.length),d=O.sizeToDimension(i,l),p=O.sizeFromDimension(i,l),h=O.size(s.dims),g=a?O.size(a.dims):0;if(h!==p||a&&g!==p)throw new Error(`Size of X.shape()[axis:] == ${p}.
  ...
  ${I.mainStart()}
    ...
    ${w?"inv_std_output[global_idx] = inv_std_dev":""};
        ...
        }`};return{name:"BlockwiseMatMulNBits32",shaderCache:{hint:`${t.blockSize};${h};${g};${k};${b}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:y,dataType:p}],dispatchGroup:{x:S},programUniforms:I}),getShaderSource:B}},lf=(e,t)=>{hd(e.inputs,t),t.blockSize===32&&e.adapterInfo.isVendor("intel")&&e.adapterInfo.isArchitecture("gen-12lp")?e.compute(md(e.inputs,t)):e.compute(fd(e.inputs,t))},df=e=>ye(e)}),x_=L(()=>{"use strict";ne(),ie(),se(),gd=e=>{if(!e||e.length<1)throw new Error("Too few inputs");if(e[0].dataType!==1&&e[0].dataType!==10)throw new Error("Input type must be float or float16.");if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},_d=(e,t,r)=>{let n="";for(let i=t-1;i>=0;--i)n+=`
      ...
      `},yd=(e,t,r)=>{let n="";for(let i=t-1;i>=0;--i)n+=`
          ...
          `},bd=(e,t,r)=>{let n="";for(let i=t-1;i>=0;--i)n+=`
            ...
            `;return`
              ...
              ${n}
              value = x[offset];
          `},$d=(e,t,r)=>{switch(r.mode){case 0:return _d(e,t,r.pads.length);case 1:return yd(e,t,r.pads.length);case 2:return wd(e,t,r.pads.length);case 3:return bd(e,t,r.pads.length);default:throw new Error("Invalid mode")}},vd=(e,t)=>{let r=O.padShape(e[0].dims.slice(),t.pads),n=e[0].dims,i=O.size(r),s=[{type:12,data:i},{type:6,data:t.pads}],a=e.length>=3&&e[2].data;t.mode===0&&s.push({type:a?e[2].dataType:1,data:t.value}),s.push(...te(e[0].dims,r));let u=["rank"],l=d=>{let p=Z("output",e[0].dataType,r.length),h=R("x",e[0].dataType,n.length),g=h.type.value,y=$d(p,n.length,t),_=[{name:"output_size",type:"u32"},{name:"pads",type:"i32",length:t.pads.length}];return t.mode===0&&_.push({name:"constant_value",type:a?g:"f32"}),`
            ...
            ${e.mainStart()}
              ...
              output[global_idx] = value;
            }`}},rs=e=>`${e.format};${e.ceilMode};${e.autoPad};${e.kernelShape.length}`,kd=e=>`${rs(e)};${e.countIncludePad}`,Sd=e=>`${rs(e)};${e.storageOrder};${e.dilations}`,ns=e=>({format:e.format,autoPad:["NOTSET","VALID","SAME_UPPER","SAME_LOWER"][e.auto_pad],ceilMode:e.ceil_mode,kernelShape:e.kernel_shape,strides:e.strides,pads:e.pads}),is=(e,t,r,n)=>{let[i,s]=Ji(t,n,r),a=R("x",t.dataType,t.dims.length),u=a.type.value,l="value += x_val;",d="";i.countIncludePad?d+=`value /= ${u}(uniforms.kernelSize);`:d+=`value /= ${u}(i32(uniforms.kernelSize) - pad);`;let[p,h,g,y,_]=es(s,i);p.push(...te(t.dims,s));let b=["rank"];return{name:e,shaderCache:{hint:`${n.cacheKey};${g};${y};${_}`,inputDependencies:b},getRunData:()=>({outputs:[{dims:s,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(O.size(s)/64)},programUniforms:p}),getShaderSource:k=>ts(k,a,t.dims.length,s.length,i,l,d,0,h,g,y,_)}},pf=e=>{let t=e.count_include_pad!==0,r=ns(e);if(r.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for AveragePool");let n={countIncludePad:t,...r,cacheKey:""};return{...n,cacheKey:kd(n)}},hf=(e,t)=>{jr(e.inputs),e.compute(is("AveragePool",e.inputs[0],!1,t))},ss={autoPad:"",ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[]},ff=e=>{let t=e.format;return{format:t,...ss,cacheKey:t}},mf=(e,t)=>{jr(e.inputs),e.compute(is("GlobalAveragePool",e.inputs[0],!0,t))},as=(e,t,r,n)=>{let[i,s]=Ji(t,n,r),a=`
      value = max(x_val, value);
    `,u="",l=R("x",t.dataType,t.dims.length),d=["rank"],[p,h,g,y,_]=es(s,i);return p.push(...te(t.dims,s)),{name:e,shaderCache:{hint:`${n.cacheKey};${g};${y};${_}`,inputDependencies:d},getRunData:()=>({outputs:[{dims:s,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(O.size(s)/64)},programUniforms:p}),getShaderSource:b=>ts(b,l,t.dims.length,s.length,i,a,u,t.dataType===10?-65504:-1e5,h,g,y,_)}},gf=(e,t)=>{jr(e.inputs),e.compute(as("MaxPool",e.inputs[0],!1,t))},_f=e=>{let t=e.storage_order,r=e.dilations,n=ns(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(n.ceilMode!==0)throw new Error("using ceil() in shape computation is not yet supported for MaxPool");let i={storageOrder:t,dilations:r,...n,cacheKey:""};return{...i,cacheKey:Sd(i)}},yf=e=>{let t=e.format;return{format:t,...ss,cacheKey:t}},wf=(e,t)=>{jr(e.inputs),e.compute(as("GlobalMaxPool",e.inputs[0],!0,t))}}),S_=L(()=>{"use strict";ne(),ie(),Me(),se(),Td=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[0].dataType===6&&e.length>2)throw new Error("In the case of dequantizing int32 there is no zero point.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((r,n)=>r===e[2].dims[n]).reduce((r,n)=>r&&n,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((i,s)=>s===t.axis||i===e[0].dims[s]).reduce((i,s)=>i&&s,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let r=e[0].dims[t.axis],n=e[1].dims[t.axis];if(t.blockSize<Math.ceil(r/n)||t.blockSize>Math.ceil(r/(n-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},Id=(e,t)=>{let r=O.normalizeAxis(t.axis,e[0].dims.length),n=e[0].dataType,i=n===3,s=e[0].dims,a=e[1].dataType,u=O.size(s),l=n===3||n===2,d=l?[Math.ceil(O.size(e[0].dims)/4)]:e[0].dims,p=e[1].dims,h=e.length>2?e[2]:void 0,g=h?l?[Math.ceil(O.size(h.dims)/4)]:h.dims:void 0,y=p.length===0||p.length===1&&p[0]===1,_=y===!1&&p.length===1,b=Ae(u),k=y&&(!l||b===4),v=k?b:1,w=k&&!l?b:1,T=R("input",l?12:n,d.length,w),S=R("scale",a,p.length),I=h?R("zero_point",l?12:n,g.length):void 0,C=Z("output",a,s.length,v),A=[T,S];I&&A.push(I);let $=[d,p];h&&$.push(g);let B=[{type:12,data:u/v},{type:12,data:r},{type:12,data:t.blockSize},...te(...$,s)],U=H=>{let W=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      }`};return{name:"DequantizeLinear",shaderCache:{hint:t.cacheKey,inputDependencies:I?["rank","rank","rank"]:["rank","rank"]},getShaderSource:U,getRunData:()=>({outputs:[{dims:s,dataType:a}],dispatchGroup:{x:Math.ceil(u/v/64),y:1,z:1},programUniforms:B})}},bf=(e,t)=>{Td(e.inputs,t),e.compute(Id(e.inputs,t))},$f=e=>ye({axis:e.axis,blockSize:e.blockSize})}),T_=L(()=>{"use strict";it(),ne(),se(),Ed=(e,t,r)=>{let n=e===t,i=e<t&&r<0,s=e>t&&r>0;if(n||i||s)throw new Error("Range these inputs' contents are invalid.")},Cd=(e,t,r,n)=>{let i=Math.abs(Math.ceil((t-e)/r)),s=[i],a=i,u=[{type:12,data:a},{type:n,data:e},{type:n,data:r},...te(s)],l=d=>{let p=Z("output",n,s.length),h=p.type.value,g=[{name:"outputSize",type:"u32"},{name:"start",type:h},{name:"delta",type:h}];return`
        ${d.registerUniforms(g).declareVariables(p)}
        ${d.mainStart()}
        ${d.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        output[global_idx] = uniforms.start + ${h}(global_idx) * uniforms.delta;
      }`};return{name:"Range",shaderCache:{hint:`${n}`},getShaderSource:l,getRunData:()=>({outputs:[{dims:s,dataType:n}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:u})}},vf=e=>{let t=0,r=0,n=0;e.inputs[0].dataType===6?(t=e.inputs[0].getInt32Array()[0],r=e.inputs[1].getInt32Array()[0],n=e.inputs[2].getInt32Array()[0]):e.inputs[0].dataType===1&&(t=e.inputs[0].getFloat32Array()[0],r=e.inputs[1].getFloat32Array()[0],n=e.inputs[2].getFloat32Array()[0]),ze.webgpu.validateInputContent&&Ed(t,r,n),e.compute(Cd(t,r,n,e.inputs[0].dataType),{inputs:[]})}}),I_=L(()=>{"use strict";ne(),ie(),Me(),se(),zd=(e,t,r,n)=>{if(e!=="none"&&n!=="i32"&&n!=="u32"&&n!=="f32")throw new Error(`Input ${n} is not supported with reduction ${e}.`);let i=`{
                var oldValue = 0;
                loop {
                  let newValueF32 =`,s=`;
              ...
              ${i}bitcast<${n}>(oldValue) + (${r})${s}`;case"max":return n==="i32"||n==="u32"?`atomicMax(&${t}, bitcast<${n}>(${r}));`:`
                ${i}max(bitcast<f32>(oldValue), (${r}))${s}`;case"min":return n==="i32"||n==="u32"?`atomicMin(&${t}, bitcast<${n}>(${r}));`:`${i}min(bitcast<${n}>(oldValue), (${r}))${s}`;case"mul":return`${i}(bitcast<${n}>(oldValue) * (${r}))${s}`;default:throw new Error(`Reduction ${e} is not supported.`)}},Ad=(e,t)=>{let r=e[0].dims,n=e[1].dims,i=r,s=1,a=Math.ceil(O.sizeToDimension(n,n.length-1)/s),u=n[n.length-1],l=O.sizeFromDimension(r,u),d=[{type:12,data:a},{type:12,data:u},{type:12,data:l},...te(e[1].dims,e[2].dims,i)],p=h=>{let g=R("indices",e[1].dataType,e[1].dims.length),y=R("updates",e[2].dataType,e[2].dims.length,s),_=t.reduction!=="none"&&t.reduction!==""?Zc("output",e[0].dataType,i.length):Z("output",e[0].dataType,i.length,s);return`
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${zd(t.reduction,"output[data_offset + i]","value",_.type.value)}
  }

      }`};return{name:"ScatterND",shaderCache:{hint:`${t.cacheKey}_${t.reduction}`,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:d}),getShaderSource:p}},xf=e=>ye({reduction:e.reduction}),kf=(e,t)=>{e.compute(Ad(e.inputs,t),{inputs:[e.inputs[1],e.inputs[2]],outputs:[]})}}),E_=L(()=>{"use strict";ne(),ie(),Me(),se(),Md=(e,t)=>{if(e.every(r=>r>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
            one outermost scale values equal to 1, or 5D with two outermost scale values equal to 1`)}else if(t.mode==="cubic"&&!(e.length===2||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1))throw new Error("Resize requires scales input size to be 2 or 4 for cubic mode")}},Od=(e,t,r)=>{t.every(i=>i>=0&&i<r||(()=>{throw new Error("Resize requires axes input values to be positive and less than rank")}));let n=new Array(r).fill(1);return t.forEach((i,s)=>n[i]=e[s]),n},Nd=(e,t,r,n,i,s)=>{let[a,u,l]=r>10?[1,2,3]:[-1,e.length>1?1:-1,-1],d=e[0].dims.length;if(a>0&&e.length>a&&e[a].dims.length>0)e[a].getFloat32Array().forEach(p=>s.push(p));else if(t.coordinateTransformMode==="tf_crop_and_resize")throw new Error("Resize requires RoI input to be specified when coordinateTransformMode is tfCropAndResize");if(u>0&&e.length>u&&e[u].dims.length===1&&e[u].dims[0]>0){if(e[u].getFloat32Array().forEach(p=>n.push(p)),n.length!==0&&n.length!==d&&r>=18&&n.length!==t.axes.length)throw new Error("Resize requires scales input size to be same as input rank or axes size for opset 18 and up");Md(n,t),t.axes.length>0&&Od(n,t.axes,d).forEach((p,h)=>n[h]=p)}if(l>0&&e.length>l&&e[l].dims.length===1&&e[l].dims[0]>0&&(e[l].getBigInt64Array().forEach(p=>i.push(Number(p))),i.length!==0&&i.length!==d&&r>=18&&i.length!==t.axes.length))throw new Error("Resize requires sizes input size to be same as input rank or axes size for opset 18 and up");if(t.axes.length>0){if(n.length!==0&&n.length!==t.axes.length)throw new Error('Resize requires "scales" input size to be of axes rank when axes attributes is specified');if(i.length!==0&&i.length!==t.axes.length)throw new Error('Resize requires "sizes" input size to be of rank axes rank when axes attributes is specified')}if(typeof n<"u"&&typeof i<"u"&&n.length>0&&i.length>d)throw new Error("Resize requires only of scales or sizes to be specified")},os=(e,t,r,n)=>`
...
`,Rd=(e,t)=>`fn getOriginalCoordinateFromResizedCoordinate(xResized: u32, xScale: f32, lengthResized: u32,
     lengthOriginal: u32, roiStart: f32, roiEnd: f32) -> ${t} { `+(()=>{switch(e){case"asymmetric":return`
        ...
        `;case"pytorch_half_pixel":return`if (lengthResized > 1) {
                  ...
                  return offset + ((${t}(xResized) + 0.5) / ${t}(xScale)) - 0.5;`;case"half_pixel":return`return ((${t}(xResized) + 0.5) / ${t}(xScale)) - 0.5;`;default:throw new Error(`Coordinate transform mode ${e} is not supported`)}})()+"}",Bd=(e,t,r)=>`fn getNearestPixelFromOriginal(xOriginal: ${r}, isDownSample: bool) -> ${r} {`+(()=>{switch(e){case"round_prefer_ceil":return"if (fract(xOriginal) == 0.5) {             return ceil(xOriginal);           } else {             return round(xOriginal);           }";case"floor":return"return floor(xOriginal);";case"ceil":return"return ceil(xOriginal);";case"round_prefer_floor":return"if (fract(xOriginal) == 0.5) {                     return floor(xOriginal);                   } else {                     return round(xOriginal);                   }";default:if(t<11)return"if (isDownSample)                     {                       return ceil(xOriginal);                     } else {                       return xOriginal;                     }";throw new Error(`Nearest mode ${e} is not supported`)}})()+"}",Dd=(e,t,r)=>{let n=new Array(r).fill(0).concat(new Array(r).fill(1)),i=e.length===0?n:e.slice();return t.length>0?(t.forEach((s,a)=>{n[s]=i[a],n[a+r]=i[t.length+a]}),n):i},Pd=(e,t,r,n)=>{let i=[];if(r.length>0)if(n.length>0){if(e.forEach(s=>i.push(s)),Math.max(...n)>e.length)throw new Error("axes is out of bound");n.forEach((s,a)=>i[s]=r[a])}else r.forEach(s=>i.push(s));else{if(t.length===0)throw new Error("Resize requires either scales or sizes.");i=e.map((s,a)=>Math.round(s*t[a]))}return i},Ud=(e,t,r)=>{let n=(()=>{switch(r.keepAspectRatioPolicy){case"not_larger":return r.axes.length>0?Math.min(...r.axes.map(s=>t[s]),Number.MAX_VALUE):Math.min(...t,Number.MAX_VALUE);case"not_smaller":return r.axes.length>0?Math.max(...r.axes.map(s=>t[s]),Number.MIN_VALUE):Math.max(...t,Number.MIN_VALUE);default:throw new Error(`Keep aspect ratio policy ${r.keepAspectRatioPolicy} is not supported`)}})();t.fill(1,0,t.length);let i=e.slice();return r.axes.length>0?(r.axes.forEach(s=>t[s]=n),r.axes.forEach(s=>i[s]=Math.round(e[s]*t[s]))):(t.fill(n,0,t.length),i.forEach((s,a)=>i[a]=Math.round(s*t[a]))),i},Ld=(e,t,r,n,i)=>`
...
`:"",qd=(e,t,r,n,i)=>{let[s,a,u,l]=r.length===2?[-1,0,1,-1]:[0,2,3,1],d=e.type.value;return`
    ...
    }`},Gd=(e,t,r,n,i,s,a,u,l,d)=>{let p=r.length===2,h=!0,[g,y]=p?[0,1]:h?[2,3]:[1,2],_=e.type.value,b=k=>{let v=k===g?"row":"col";return`
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${_} {
    ...
    `},Vd=(e,t,r,n,i)=>{let[s,a,u,l,d]=r.length===3?[-1,0,1,2,-1]:[0,2,3,4,1],p=e.type.value;return`
    ...
    }`},Hd=(e,t,r,n,i,s)=>{let a=e.dims,u=Dd(s,t.axes,a.length),l=Pd(a,n,i,t.axes),d=n.slice();n.length===0&&(d=a.map((w,T)=>w===0?1:l[T]/w),t.keepAspectRatioPolicy!=="stretch"&&(l=Ud(a,d,t)));let p=Z("output",e.dataType,l.length),h=R("input",e.dataType,a.length),g=O.size(l),y=a.length===l.length&&a.every((w,T)=>w===l[T]),_=t.coordinateTransformMode==="tf_crop_and_resize",b=t.extrapolationValue,k=h.type.value,v=w=>`
      ${y?"":`
      ${Rd(t.coordinateTransformMode,k)};
      ${(()=>{switch(t.mode){case"nearest":return`
              ${Wd(h,a)};
              ${Bd(t.nearestMode,r,k)};
              ${Fd(h,p,a,l,d.length,u.length,_)};
              `;case"linear":return`
              ${Ld(p,a,l,d.length,u.length)};
              ${(()=>{if(a.length===2||a.length===4)return`${qd(h,p,a,_,b)}`;if(a.length===3||a.length===5)return`${Vd(h,p,a,_,b)}`;throw Error("Linear mode only supports input dims 2, 3, 4 and 5 are supported in linear mode.")})()};
            `;case"cubic":return`
            ${(()=>{if(a.length===2||a.length===4)return`${Gd(h,p,a,l,d,u,t.cubicCoeffA,_,t.extrapolationValue,t.excludeOutside)}`;throw Error("Cubic mode only supports input dims 2 and 4 are supported in linear mode.")})()};
...
`}
      ...
      }`},S=[{dims:u,dataType:e[0].dataType}];return r>1&&S.push({dims:p,dataType:1}),r>2&&S.push({dims:p,dataType:1}),r>3&&S.push({dims:s,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:`${v};${y};${_};${b}`,inputDependencies:e.map((I,C)=>"type")},getShaderSource:T,getRunData:()=>({outputs:S,dispatchGroup:{x:Math.ceil(l/d)},programUniforms:w})}},If=(e,t)=>{Kd(e.inputs);let r=[0];e.outputCount>1&&r.push(-3),e.outputCount>2&&r.push(-3),e.outputCount>3&&r.push(3),e.compute(Qd(e.inputs,t,e.outputCount,!1),{outputs:r})}}),z_=L(()=>{"use strict";ne(),ie(),Me(),se(),Xd=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((r,n)=>{if(e[n+1].dataType!==6&&e[n+1].dataType!==7)throw new Error(`Input ${n} must be an array of int32 or int64`)})},Kr=(e,t)=>{let r=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(n=>r.push(Number(n)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(n=>r.push(Number(n)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return r},Zd=(e,t)=>{if(e.length>1){let r=Kr(e,1),n=Kr(e,2),i=Kr(e,3);return i.length===0&&(i=[...Array(e[0].dims.length).keys()]),ye({starts:r,ends:n,axes:i})}else return t},ls=(e,t,r,n,i)=>{let s=e;return e<0&&(s+=r[n[t]]),i[t]<0?Math.max(0,Math.min(s,r[n[t]]-1)):Math.max(0,Math.min(s,r[n[t]]))},Yd=(e,t,r)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
      ...
      }`;return{name:"Slice",shaderCache:{hint:`${l.length}_${a.length}_${s.length}`,inputDependencies:["rank"]},getShaderSource:k,getRunData:()=>({outputs:[p],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:b})}},Ef=(e,t)=>{Xd(e.inputs,t);let r=Zd(e.inputs,t);e.compute(Jd(e.inputs,r),{inputs:[0]})},Cf=e=>{let t=e.starts,r=e.ends,n=e.axes;return ye({starts:t,ends:r,axes:n})}}),A_=L(()=>{"use strict";ne(),ie(),Me(),Yt(),se(),ec=e=>{if(!e||e.length!==1)throw new Error("Softmax op requires 1 input.")},tc=(e,t)=>{let r=e.inputs[0],n=r.dims,i=O.size(n),s=n.length,a=O.normalizeAxis(t.axis,s),u=a<n.length-1,l,d=[];u?(d=Array.from({length:s},(A,$)=>$),d[a]=s-1,d[s-1]=a,l=e.compute(Je(r,d),{inputs:[r],outputs:[-1]})[0]):l=r;let p=l.dims,h=p[s-1],g=i/h,y=Ae(h),_=h/y,b=64;g===1&&(b=256);let k=(A,$)=>$===4?`max(max(${A}.x, ${A}.y), max(${A}.z, ${A}.w))`:$===2?`max(${A}.x, ${A}.y)`:$===3?`max(max(${A}.x, ${A}.y), ${A}.z)`:A,v=R("x",l.dataType,l.dims,y),w=Z("result",l.dataType,l.dims,y),T=v.type.value,S=De(l.dataType)==="f32"?`var threadMax = ${T}(-3.4028234663852886e+38f);`:`var threadMax = ${T}(-65504.0h);`,I=A=>`
