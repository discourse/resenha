...
const VOICE_STORAGE_KEY = "resenha_voice_quality";
const CAMERA_STORAGE_KEY = "resenha_camera_quality";
const SCREEN_STORAGE_KEY = "resenha_screen_quality";
const SCREEN_CONTENT_STORAGE_KEY = "resenha_screen_content";
