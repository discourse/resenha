...
desc "Clear all pinned Resenha voice-room transports"
task "resenha:clear_transport_pins" => :environment do
  cleared = 0

  Discourse
    .redis
    .scan_each(match: "#{Resenha::ParticipantTracker::KEY_NAMESPACE}:*:transport") do |key|
