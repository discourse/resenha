...
export const STT_WORKER_FILE = "${WORKER_NAME}";
export const VAD_BUNDLE_FILE = "${VAD_BUNDLE_NAME}";
export const ORT_WASM_JS_FILE = "${ORT_DIR}/ort-wasm-simd-threaded.jsep.js";
export const ORT_WASM_BINARY_FILE = "${ORT_DIR}/ort-wasm-simd-threaded.jsep.wasm";
export const VAD_ASSET_DIR = "${VAD_DIR}/";
EOF
