...
module Resenha
  class ChatThreadsController < ApplicationController
    ...
    def show
      raise Discourse::NotFound unless Resenha::ChatSession.chat_available?
      ...
      room = Resenha::Room.find_by(id: thread.custom_fields[Resenha::THREAD_ROOM_ID_FIELD].to_i)
      ...
      raise Discourse::NotFound unless guardian.can_see_resenha_room?(room)
      ...
      render json: {
               ...
               # already rolled over.
               chat_active: Resenha::ChatSession.state(room)[:thread_id] == thread.id,
             }
    end
