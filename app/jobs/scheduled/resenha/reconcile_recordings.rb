  ...
  module Resenha
    ...
    class ReconcileRecordings < ::Jobs::Scheduled
      ...
      def execute(_args)
        ...
        return unless SiteSetting.resenha_livekit_recording_enabled
        return unless ::Resenha::Livekit.configured?
        # The common case is no unresolved recordings — skip without HTTP.
        return unless ::Resenha::Recording.recording.exists?

        ::Resenha::RecordingManager.reconcile_pending!
      end
    end
  end
end
