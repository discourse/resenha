...
module Resenha
  ...
  class Recording < ActiveRecord::Base
    self.table_name = "#{Resenha.table_name_prefix}recordings"
...
# Indexes
#
#  index_resenha_recordings_on_egress_id               (egress_id) UNIQUE
#  index_resenha_recordings_on_room_id_and_started_at  (room_id,started_at)
#
