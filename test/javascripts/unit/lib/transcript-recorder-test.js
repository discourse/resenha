...
import TranscriptRecorder from "discourse/plugins/resenha/discourse/lib/resenha/transcript-recorder";

module("Resenha | Unit | Lib | transcript-recorder", function (hooks) {
  setupTest(hooks);
