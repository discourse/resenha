...
const STORAGE_KEYS = [
  "resenha:noise-suppression",
  "resenha:noise-suppression-mode",
  "resenha:echo-cancellation",
  "resenha:auto-gain-control",
];
...
module("Resenha | Unit | Lib | local-audio-pipeline", function (hooks) {
  ...
  test("echo cancellation and auto gain changes recapture with new constraints", async function (assert) {
    ...
    assert.strictEqual(localStorage.getItem("resenha:echo-cancellation"), "0");
