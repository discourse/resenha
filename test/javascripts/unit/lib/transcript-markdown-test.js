...
import { transcriptToMarkdown } from "discourse/plugins/resenha/discourse/lib/resenha/transcript-markdown";

module("Resenha | Unit | Lib | transcript-markdown", function (hooks) {
  setupTest(hooks);
